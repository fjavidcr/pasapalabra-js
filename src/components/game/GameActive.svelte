...
{#if game.status === "playing"}
  <div class="flex flex-col items-center w-full max-w-2xl mx-auto gap-8 md:gap-12 px-4 sm:px-8 py-8 animate-in fade-in zoom-in duration-500">
    {#if modelLabel}
      <div class="text-sm font-medium text-slate-400/80 bg-slate-900/50 px-4 py-2 rounded-full border border-slate-700/50 flex items-center shadow-lg gap-2 mt-[-1rem]">
