...
- **CPU Time (10ms)**: El límite de 10ms es generoso para renderizar un rosco, pero hay que tener cuidado con el parsing de la respuesta de Gemini. Si el JSON es muy grande o el componente Svelte muy complejo, podríamos rozar el límite. _Dato: El tiempo de espera de red (Gemini) NO cuenta para estos 10ms._
